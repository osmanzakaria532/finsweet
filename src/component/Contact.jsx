          ...
          <div className="sm:w-[624px] bg-[#1C1E53] text-center sm:text-start">
            <div className="sm:w-[432px] mx-auto pt-24 pb-[48px] px-3 sm:px-0">
              ...
              <form className="flex flex-col gap-y-4 mb-[48px]">
                ...
                <input
                  placeholder="Email"
                  className="py-[18px] px-8 rounded-[8px] bg-[#1C1E53] border border-[rgba(255,255,255,0.05)] focus:outline-none placeholder:text-[#F4F6FC]/50 placeholder:text-base placeholder:font-Poppins placeholder:leading-7"
                />
                <input
