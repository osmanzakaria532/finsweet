        ...
        <Container className="flex justify-between">
          ...
          <div className="sm:w-[846px] h-[500px] overflow-hidden">
            <div id="accordionExample">
              {/* accordion_1 */}
              <div className="border-y bg-white dark:border-neutral-600 dark:bg-neutral-800">
                <h2 className="mb-0 flex  " id="headingOne">
                  <div
                    className={`${
                      show.collapse1 && `text-[#282938] dark:!text-primary-400 `
                    } group relative flex items-center gap-x-[53px] w-full rounded-t-[15px] border-0 bg-white py-4 text-left text-neutral-800 transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none dark:bg-neutral-800 dark:text-white font-Poppins font-medium text-2xl`}
                    type="button"
                    onClick={() =>
                  ...
                  >
                    <div className="w-9 ml-[27px] text-[#2405F2] text-2xl text-center font-Poppins font-medium leading-9">
                      01
                    </div>
                ...
                >
                  <div className="sm:w-[624px] py-4 ml-[113px] pr-5 text-[#282938] text-lg font-Poppins font-medium">
              ...
              {/* accordion_2 */}
              <div className="border-b bg-white dark:border-neutral-600 dark:bg-neutral-800">
                <h2 className="mb-0 flex  " id="headingTwo">
                  <div
                    className={`${
                      show.collapse2 && `text-[#282938] dark:!text-primary-400 `
                    } group relative flex items-center gap-x-[53px] w-full rounded-t-[15px] border-0 bg-white py-4 text-left text-neutral-800 transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none dark:bg-neutral-800 dark:text-white font-Poppins font-medium text-2xl`}
                    type="button"
                    onClick={() =>
              ...
              <div className="border-b bg-white dark:border-neutral-600 dark:bg-neutral-800">
                <h2 className="mb-0 flex  " id="headingThree">
                  <div
                    className={`${
                      show.collapse3 && `text-[#282938] dark:!text-primary-400 `
                    } group relative flex items-center gap-x-[53px] w-full rounded-t-[15px] border-0 bg-white py-4 text-left text-neutral-800 transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none dark:bg-neutral-800 dark:text-white font-Poppins font-medium text-2xl`}
                    type="button"
                    onClick={() =>
              ...
              <div className="border-b bg-white dark:border-neutral-600 dark:bg-neutral-800">
                <h2 className="mb-0 flex  " id="headingFour">
                  <div
                    className={`${
                      show.collapse4 && `text-[#282938] dark:!text-primary-400 `
                    } group relative flex items-center gap-x-[53px] w-full rounded-t-[15px] border-0 bg-white py-4 text-left text-neutral-800 transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none dark:bg-neutral-800 dark:text-white font-Poppins font-medium text-2xl`}
                    type="button"
                    onClick={() =>
                      toggleShow({ ...show, collapse4: !show.collapse4 })
                    }
                    aria-expanded="true"
                    aria-controls="collapseOne"
                  >
              ...
              <div className="border-b bg-white dark:border-neutral-600 dark:bg-neutral-800">
                <h2 className="mb-0 flex  " id="headingFive">
                  <div
                    className={`${
                      show.collapse5 && `text-[#282938] dark:!text-primary-400 `
                    } group relative flex items-center gap-x-[53px] w-full rounded-t-[15px] border-0 bg-white py-4 text-left text-neutral-800 transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none dark:bg-neutral-800 dark:text-white font-Poppins font-medium text-2xl`}
                    type="button"
                    onClick={() =>
                      toggleShow({ ...show, collapse5: !show.collapse5 })
                    }
                    aria-expanded="true"
                    aria-controls="collapseOne"
                  >
